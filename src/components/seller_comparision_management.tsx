              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Examples: https://amazon.com/dp/B08XYZ1234 or just B08XYZ1234
                  </p>
                </div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => window.open(`https://amazon.com/dp/${extractedAsin}`, '_blank')}
                        ...
                        <tr key={mapping.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2 justify-end">
                              <button
                                onClick={() => window.open(`https://amazon.com/dp/${mapping.competitor_asin}`, '_blank')}
